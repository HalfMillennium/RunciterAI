    ...
    <div className="hidden md:flex flex-col h-screen w-64 bg-[#191919] dark:bg-[#191919] text-gray-200 border-r border-neutral-800">
      ...
      <div className="flex items-center p-4 border-b border-neutral-800">
        <div className="flex items-center space-x-2 h-12">
          <img className="h-12" src={appLogo} />
        </div>
      </div>
      ...
      <div className="px-2 flex-1 overflow-y-auto">
        <div className="space-y-1 py-2">
          <Link href="/">
            <Button
              variant="ghost"
              className="w-full justify-start font-normal px-2 hover:bg-neutral-800 text-gray-300"
            >
                    ...
                    <Button
                      ...
                      className={`w-full justify-start font-normal px-2 hover:bg-neutral-800 ${
                        currentDocumentId === document.id
                          ? "text-white bg-opacity-20 bg-neutral-700"
                          : "text-gray-300"
                      }`}
                    >
      ...
      <div className="p-3 border-t border-neutral-800">
        <Button
          variant="ghost"
          className="w-full justify-start font-normal hover:bg-neutral-800 text-gray-300"
        >
