...
import appLogo from "../assets/runciter_logo_weird.png";
          ...
          <div className="md:hidden absolute top-full left-0 right-0 bg-gray-900/95 backdrop-blur-md border-b border-white/10 p-4 z-50">
            <div className="flex flex-col space-y-4">
              <Link href="/" onClick={() => setMobileMenuOpen(false)}>
                <span className="text-sm hover:text-blue-400 transition block py-2">
                  Home
                </span>
              </Link>
      ...
      <div className="relative z-10 container mx-auto px-4 py-24 md:py-32">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-gray-300 mb-10 mx-auto max-w-2xl">
            Enhance your documents with intelligent suggestions, generated
            content, and a seamless writing experience.
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="rounded-xl bg-gradient-to-b from-white/5 to-white/[0.02] border border-white/10 p-6 backdrop-blur-sm hover:shadow-xl hover:shadow-blue-500/5 transition">
            ...
            <p className="text-gray-400">
              Get intelligent content suggestions as you write, helping you
              overcome writer's block and enhance your documents.
            </p>
          </div>
          ...
          <div className="rounded-xl bg-gradient-to-b from-white/5 to-white/[0.02] border border-white/10 p-6 backdrop-blur-sm hover:shadow-xl hover:shadow-blue-500/5 transition">
            ...
            <p className="text-gray-400">
              A clean, distraction-free writing environment that lets you focus
              on your content with a minimal, beautiful interface.
            </p>
          </div>
          ...
          <div className="rounded-xl bg-gradient-to-b from-white/5 to-white/[0.02] border border-white/10 p-6 backdrop-blur-sm hover:shadow-xl hover:shadow-blue-500/5 transition">
            ...
            <p className="text-gray-400">
              Your documents are automatically saved as you type, ensuring you
              never lose your work and can access it from anywhere.
            </p>
          </div>
        </div>
      </div>
